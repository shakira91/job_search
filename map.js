...
var marker; 
  ...
  var initDestinationPopUp = function(destinationDetails, companies) {
    ...
    details.push("From the location previously entered, you'd reach this job location in <strong>" + distance + "</strong> and " + duration + ". <br>You'd have to take " + transitAgency +"\'s "+ trainLine, trainName + " train" + " to " + finalStop + ".");
